...
from my_token.serializers import UserSerializer, DBSourceSerializer
...
class DBSourceViewSet(viewsets.ModelViewSet):
    """ 任务代码
    """
    permission_classes = (CustomPermission,)  # 设置权限

    queryset = DBSourceModel.objects.all()
    serializer_class = DBSourceSerializer
